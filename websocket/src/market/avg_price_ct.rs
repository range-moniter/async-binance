...
#[async_trait]
impl<P> BinanceWebsocketAdaptor<P> for AveragePriceClient
where
    P: SocketPayloadProcess<AveragePricePayload> + 'static + Send,
{
    ...
    async fn create_client(process: P) -> Self::CLIENT {
        ...
        AveragePriceClient{websocket_client: client}
    }
