...
pub struct SpotAggTradeClient {
    websocket_client: WebsocketClient<AggTradeStream>,
}

#[async_trait]
impl BinanceWebsocketAdaptor for SpotAggTradeClient {
    type CLIENT = SpotAggTradeClient;
    type INPUT = Symbol;
...
mod tests {
    ...
    async fn test_agg_trade() {
        ...
        let mut trade_client = BinanceSpotMarketWebsocketClient::agg_trade(DefaultStreamPayloadProcess::new()).await;
